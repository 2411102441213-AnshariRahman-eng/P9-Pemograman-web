...
// Menangani kasus jika checkbox status tidak dicentang (nilai 'status' mungkin kosong)
$statusTampil = isset($statusMenikah) ? $statusMenikah : 'Belum Menikah'; 
echo "<tr><td>Status Menikah</td><td>:</td><td>$statusTampil</td></tr>";
